...
<?php
	if(isset($_POST['sub'])){
        ...
        <br>
        <p><button class="btn btn-primary"><a href="http://localhost:8080/DBMS/ticket3/movie_ticket/passwordreset.php">Reset Password</a></button></p>
        <br>
        ...
        <div class="table-responsive">  
            ...
            <div class="box">
                <form action="" method="post" >  
                    ...
                    <div class="form-group">
                        <input type="submit" name="sub" value="Send Password Reset Link" class="btn btn-success" />
                    </div>
