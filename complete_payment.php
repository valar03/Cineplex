...
if($otp=="123456")
{
        ...
        mysqli_query($con,"insert into tbl_bookings values(NULL,'$bookid','".$_SESSION['theatre']."','".$_SESSION['user']."','".$_SESSION['show']."','".$_SESSION['screen']."','".$_SESSION['num_seats']."','".$_SESSION['selected_seats']."','".$_SESSION['total_amount']."','".$_SESSION['date']."',CURDATE(),'1')");
